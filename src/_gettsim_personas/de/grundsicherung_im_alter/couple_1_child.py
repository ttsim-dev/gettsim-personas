...
@persona_description(
    description="""Jointly-taxed married couple of retirees with an adult child living
                in a separate household. Statutory pension benefits are fixed. Use this
                persona to compute income taxes, social security contributions,
                Wohngeld, and Grundsicherung.""",
...
def sozialversicherung__rente__altersrente__betrag_m() -> np.ndarray:
    return np.array([500.0, 200.0, 0.0])
...
def sozialversicherung__rente__jahr_renteneintritt(
    ...
    return np.array([evaluation_date.year, evaluation_date.year, evaluation_date.year])
