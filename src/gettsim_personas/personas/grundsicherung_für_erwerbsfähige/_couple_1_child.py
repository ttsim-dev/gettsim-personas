...
@input_column(start_date="2005-01-01")
def p_id() -> np.ndarray:
...
@input_column(start_date="2005-01-01", end_date="2022-12-31")
...
@input_column(start_date="2005-01-01", end_date="2008-12-31")
...
@input_column(start_date="2005-01-01", end_date="2024-01-01")
def wohnort_ost_hh() -> np.ndarray:
    return np.array([False, False, False])


@target_column(start_date="2005-01-01")
...
@target_column(start_date="2005-01-01", end_date="2022-12-31")
