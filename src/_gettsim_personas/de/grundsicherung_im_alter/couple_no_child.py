...
@persona_description(
    ...
    pension benefits, and income taxes for a jointly-taxed married couple without
    children. Both partners receive Altersrente from the statutory pension system.""",
