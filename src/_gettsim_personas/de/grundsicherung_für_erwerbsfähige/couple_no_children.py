...
@persona_description(
    ...
    Jointly taxed married couple without children where one partner is the sole
    earner. Income from pensions, parental leave benefits and subsistence benefits
    for the elderly are set to zero.""",
