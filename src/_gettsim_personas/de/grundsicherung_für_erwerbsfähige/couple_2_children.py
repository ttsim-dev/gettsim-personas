...
@persona_description(
    ...
    Jointly taxed married couple with two children. Income from pensions, parental
    leave benefits and subsistence benefits for the elderly are set to zero.""",
